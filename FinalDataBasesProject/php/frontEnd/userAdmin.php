    ...
    <div class="section">
        ...
        <div class="tablediv">
            <form method="post" action="userAdmin.php">
                <h2><b>Forum Messages</b></h2>

                <?php
                $result = $conn->query("SELECT * FROM forummessage WHERE isVisible=1");
                ...
                if ($resultsCount > 0) {
                    ...
                    for ($i = 1; $i <= $resultsCount; $i++) {
                        ...
                        echo '<tr>
                                ...
                                <td>' . $email  . '</td>
                                <td>' . $message . '</td>
                                <td><form method="post" action="userAdmin.php"><button type="submit" name="delete" value=' . "$id" . ' class="button">DELETE</button></form>
                                </td>
                                </tr>';
                    }
                    echo '</table>';
                } else {
                    echo '<div id=nresponse>No messages found...</div>';
                }
                ?>
            </form>
        </div>
