...
<body>
    ...
    <div class="section">
        ...
        <div class="tablediv">
            <form method="post" action="userAdminNotification.php">
                <?php
                $result = $conn->query("SELECT * FROM notifications WHERE isvisible=1");

                $resultsCount = mysqli_num_rows($result);
                if ($resultsCount > 0) {
                    echo '<h2><b>Notifications</b></h2>
                            <table id="msgTable"> 
                            <tr>   
                    ...
                    for ($i = 1; $i <= $resultsCount; $i++) {
                        ...
                        echo '<tr>
                                ...
                                <td>' . $message . '</td>
                                <td>' . $user . '</td>
                                <td><form method="post" action="userAdminNotification.php"><button type="submit" name="delete" value=' . "$id" . ' class="button">DELETE</button></form>
                                </td>
                                </tr>';
                    }
                    echo '</table>';
                } else {
                    echo '<div id=nresponse>No notifications found...</div>';
                }
                ?>
            </form>
        </div>
