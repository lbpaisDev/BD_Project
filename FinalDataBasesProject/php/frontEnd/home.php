                ...
                <div class="text-content">
                    ...
                    <table class="table">
                        ...
                        <?php
                            ...
                            $sql="SELECT tournament.tournamentid,tournament.tournamentname, tournament.freespots, tournament.currentteams, tournament.startdate, tournament.enddate, tournamentdetails.gameweekday, tournamentdetails.gamestarttime from tournament, tournamentdetails WHERE tournamentdetails.tournament_tournamentid=tournament.tournamentid Order by 2";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    // echo $url;
                                    echo "<td>".$row["tournamentname"]."</td>"."<td>".$row["startdate"]."</td>"."<td>".$row["enddate"]."</td>"."<td><a class='button' href='".$url."'><b>Info</b></a></td>";
            ...
            <div class="col-lg-4">
                <div class="text-content">
                    ...
                    <div class="primary-white-button">
                        <a href="./torneios.php" ><b>Jogar Já</b></a>
                ...
                <div class="text-content">
                    ...
                    <table class="table">
                        ...
                        <?php
                            // $sql = "SELECT username, email, contact,name FROM `user` ORDER BY 1";
                            // $sql="SELECT `tournamentid`,`tournamentname`,`freespots`,`currentteams`,`startdate`,`enddate` FROM `tournament` Order by 2";
                            $sql="SELECT captain_team.team_teamname,tournamentdetails.gameweekday,tournamentdetails.gamestarttime FROM captain_team,request,tournamentdetails 
                            WHERE captain_team.team_teamname=request.teamname 
                            and request.accepted='1'
                            and tournamentdetails.tournament_tournamentid=captain_team.tournament_tournamentid";
                            $result = mysqli_query($conn, $sql);
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    // $url="./torneioPage.php?torneio_id=".$row["tournamentid"];
                                    // echo $url;
                                    echo "<td>".$row["team_teamname"]."</td>"."<td>".$row["gameweekday"]."</td>"."<td>".$row["gamestarttime"]."</td>";
                                    // echo "<td>".$row["tournamentname"]."</td>"."<td>".$row["freespots"]."</td>"."</td>" ."<td>".$row["currentteams"]."</td>"."<td>".$row["gameweekday"]."</td>"."<td>".$row["gamestarttime"]."</td>"."<td>".$row["startdate"]."</td>"."<td>".$row["enddate"]."</td>"."<td><a  class='button' href='./torneiopage.php?torneio_id=1'>Info</a></td>";
                                    echo "</tr>";
                                }
                            }
