                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <a href="#" data-id="about"><b>Torneios</b></a>
                        </li>
                        <li>
                        ...
                        <?php
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    // echo $url;
                                    echo "<td>".$row["tournamentname"]."</td>"."<td>".$row["freespots"]."</td>"."</td>" ."<td>".$row["currentteams"]."</td>"."<td>".$row["gameweekday"]."</td>"."<td>".$row["gamestarttime"]."</td>"."<td>".$row["startdate"]."</td>"."<td>".$row["enddate"]."</td>"."<td><a class='button' href='".$url."'><b>Info</b></a></td>";
