            ...
            <div>
                ...
                <div class="col-lg-6" style="position:relative; left:26%;!important" >
                    <div class="text-content">
                        ...
                        <?php
                            $sql="SELECT teamone,teamtwo,goalsteam1manager,goalsteam2manager from game WHERE tournament_tournamentid=$torId and check_game=1";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while($row = mysqli_fetch_assoc($result)) {
                                    echo "<tr>";
                                    echo "<td></td><td></td><td>".$row["teamone"]."</td>"."<td>".$row["goalsteam1manager"]."-".$row["goalsteam2manager"]."</td>"."<td>".$row["teamtwo"]."</td>";
                                    echo "</tr>";
                                }
                            }
                        ?>  
